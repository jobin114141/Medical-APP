...
import 'package:medicalapp3/PatientPages/bookingConformpage.dart';

class DocAppoinment extends StatefulWidget {
  final String docid;
  final String username;
  const DocAppoinment({Key? key, required this.docid, required this.username})
      : super(key: key);

  @override
  State<DocAppoinment> createState() => _DocAppoinmentState();
}

class _DocAppoinmentState extends State<DocAppoinment> {
  ...
  void idGenerator() {
    ...
    String temp = now.microsecondsSinceEpoch.toString();
    BookingId = temp.substring(temp.length - 6);
  }
  ...
  Future<void> bookAppointment() async {
    try {
      await FirebaseFirestore.instance.collection('appointments').add({
        ...
        'patientID': user?.uid,
        'Pname': widget.username,
        'date': selectedValue,
        'time': TimeOfAppoinment,
        'status': 'booked',
        'Lab': 'false',
        'BookingId':BookingId
      });
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: Image(
                                  image: NetworkImage(
                                      "https://cdn.iconscout.com/icon/premium/png-256-thumb/hospital-2354108-1960278.png?f=webp&w=256"),
                                  fit: BoxFit.cover,
                                ),
                              ),
                              Text(
              ...
              onTap: () {
                ...
                Navigator.of(context).push(MaterialPageRoute(builder: (ctx) {
                  return BookingConform(
                      TimeOfAppoinment: TimeOfAppoinment.toString(),
                      specialization: specialization.toString(),
                      selectedValue: selectedValue.toString(),
                      Drname: Drname.toString(),
                      image_url: image_url.toString(),Bookingid:BookingId.toString());
                }));
              },
              child: Container(
